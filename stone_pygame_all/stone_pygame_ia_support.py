...
INITIAL_MAZE = "C:/temp_apagar_maze/initial_maze_hash.txt" #initial para usar o debug

# Previous steps
MEMORY = 'steps_memory_pygame_ia.csv'

# rgb colors
WHITE = 'white' # colors can also be in rbg: (255, 255, 255)
YELLOW = 'yellow'
GREEN = 'green'
RED = 'red'
BLACK = 'black'

# Size of the blocks in the game, proportional to 87 collumns x 67 rows from the maze
BLOCK_SIZE = (10, 10) #(x, y)
